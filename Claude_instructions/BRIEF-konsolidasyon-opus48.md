...
| **B2/B3/B4/B6/B7** | BEKLIYOR | — | Sonraki oturum (mod rozeti, kısayollar, tutamaç affordance, parsel kapanış, denetim→eylem). Sonra yol ayrımı: L1-A ya da A7 — kullanıcı seçer. |
| **C / D** | BEKLIYOR | — | D ayrı oturum. |
