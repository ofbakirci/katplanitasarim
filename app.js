...
let parcelSat = null;         // uydu arka planı: {url, x, y, w, h} (dünya koord.) | null
...
function clearCanvasForNewBlock(){
  ...
  document.getElementById('svgBtn').disabled=true; document.getElementById('pngBtn').disabled=true; document.getElementById('aiPaintBtn').disabled=true;
